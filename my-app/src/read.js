...
export default function Read(){
    ...
    return(
        < div className="pt-5 container background">
        <div className=" text-dark  log">
            <div>
            <h1 className="text-center fst-italic text-dark">Login Details</h1>
        ...
        <br></br>
        <div className="pt-5 ">
        <div className=" text-dark container face">
            <div>
            <h1 className="text-center fst-italic text-dark">Facebook  Details</h1>
